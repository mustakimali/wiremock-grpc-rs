...
pub mod greeter_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn weather_info(
        ...
        ) -> std::result::Result<tonic::Response<super::WeatherReply>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
            ...
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("hello.Greeter", "WeatherInfo"));
            self.inner.unary(req, path, codec).await
        }
    }
}
                ...
                "/hello.Greeter/WeatherInfo" => {
                    ...
                    for WeatherInfoSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Greeter>::weather_info(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
